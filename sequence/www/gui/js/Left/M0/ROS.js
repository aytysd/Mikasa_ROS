class M0ROS
{
    ...
    constructor( ros )
    {
        ...
        this.FireParam = new ROSLIB.Param({
            ros : this.ros,
            name : '/shoot_spot_node/DynamicShootParam/M0/fire'
        });

        this.TargetSpotParam = new ROSLIB.Param({
            ros : this.ros,
            name : '/shoot_spot_node/DynamicShootParam/M0/where'
        });
    ...
    SetShootSpeed( speed, shoot_point ,Target )
    {
        ...
        var Param = new ROSLIB.Param({
            ros : this.ros,
            name : '/shoot_spot_node/DynamicShootParam' + ShootPoint + '/M0/' + Target + '/velocity'
        });
    ...
    SetSteeringDev( dev, shoot_point, Target )
    {
        ...
        var Param = new ROSLIB.Param({
            ros : this.ros,
            name : '/shoot_spot_node/DynamicShootParam' + ShootPoint + '/M0/' + Target + '/SteeringDev'
        });
    ...
    SetElevationAngle( angle,shoot_point,Target )
    {
        ...
        var Param = new ROSLIB.Param({
            ros : this.ros,
            name : '/shoot_spot_node/DynamicShootParam' + ShootPoint + '/M0/' + Target + '/ElevationAngle'
        });
