...
M0.TargetSpotController = 
{
    TARGET_SPOT_ASSIGN :
    {
        'a' : [ 'S_K1', 'Sb1', 'Sa1', 'Sa2', 'Sa3', 'Sb2', 'S_K2',  'Ba_left', 'Bb'],
        'b' : [ 'S_K1', 'Sb1', 'Sa1', 'Sa2', 'Sa3', 'Sb2', 'S_K2',  'Ba_left', 'Bb'],
        'c' : [ 'S_K1', 'Sb1', 'Sa1', 'Sa2', 'Sa3', 'Sb2', 'S_K2',  '-', '-' ],
        'd' : [ 'S_K1', 'Sb1', "Sa1", 'Sa2', "Sa3", "Sb2", 'S_K2', "Ba_right", "Bb"],
        'e' : [ 'S_K1', 'Sb1', "Sa1", 'Sa2', "Sa3", "Sb2", 'S_K2', "Ba_right", "Bb"]
    },
    ...
    SetTargetSpot : function( ShootSpotInString )
    {
        ...
        TargetSpotList = M0.TargetSpotController.TARGET_SPOT_ASSIGN[ ShootSpotInString ];
    ...
    SetShootSpotChecked : function( spot_num )
    {
        ...
        var CurrentTargetSpotSelectionInString = M0.TargetSpotController.m_CurrentSelectableChoices[ spot_num ];

        if( CurrentTargetSpotSelectionInString != undefined )
        {
            M0.Updater.UpdateFromROSParam( { ShootSpotInString : CurrentShootSpotSelectionInString, TargetSpotInString : CurrentTargetSpotSelectionInString } );
            Talker.M0.SetTargetSpot( CurrentTargetSpotSelectionInString );
        }
    ...
    GetCurrentTargetSpotSelection : function()
    {
        ...
        console.log(this.m_CurrentSelectableChoices[ CheckedNum ])
