...
M3.ShootSpeedController = 
{
    ...
    SetShootDownSpeed : function( value, ShootSpotInString, TargetSpotInString )
    {
        ...
        Talker.M3.SetShootSpeed( value, ShootSpotInString, TargetSpotInString );
    },

    SetShootDownSpeedFromParam : function()
    {
        var CurrentTargetSpotSelectionInString = M3.TargetSpotController.GetCurrentTargetSpotSelection();
        ...
        (
            function( param )
            {
                M3.ShootSpeedController.SetDisplayShootSpeed( param * 1000.0 );
                M3.ShootSpeedController.m_ShootSpeedInfos[ CurrentShootSpotSelectionInString ][ CurrentTargetSpotSelectionInString ] = param * 1000.0;
    ...
    Init : function()
    {
        ...
        (
            function( param )
            {
                M3.ShootSpeedController.SetShootDownSpeed( param * 1000.0 );
            },
            'a',
            'Sa1'
        );
