...
const UnderCarriageFlag = true;
const MechFlag = false;
...
GamePad = 
{
    ...
    )
    {
        if( this.m_f_Enabled )
        {
            ...
            document.getElementById("joy_stick1").style.top  = (26.5+LSV)+"%";
            document.getElementById("joy_stick1").style.left = (27.8+LSH)+"%";
            document.getElementById("joy_stick2").style.top  = (26.5+RSV)+"%";
            document.getElementById("joy_stick2").style.left = (48.0+RSH)+"%";
    ...
    Toggle : function()
    {
        ...
        if( this.m_f_Enabled )
        {
            ...
            if( this.m_f_Mode == MechFlag )
            {
                document.body.style.backgroundColor = "black";

            }
            else if( this.m_f_Mode == UnderCarriageFlag )
            {
    ...
    SetMode : function( Mode )
    {
        ...
        Mechanism.FireStatusController.Stop();
        UnderCarriage.FireStatusController.Stop();
