class M4ROS
{
    ...
    constructor( ros )
    {
        ...
        this.SteeringAngleDevParam = new ROSLIB.Param({
            ros : this.ros,
            name : '/shoot_spot_node/DynamicShootParam/M4/SteeringDev'
        });

        this.FireParam = new ROSLIB.Param({
            ros : this.ros,
            name : '/shoot_spot_node/DynamicShootParam/M4/fire'
        });

        this.TargetSpotParam = new ROSLIB.Param({
            ros : this.ros,
            name : '/shoot_spot_node/DynamicShootParam/M4/where'
        });

        this.VelocityParam = new ROSLIB.Param({
            ros : this.ros,
            name : '/shoot_spot_node/DynamicShootParam/M4/velocity'
        });
    ...
    SetShootSpeed( speed, shoot_point ,Target )
    {
        ...
        var Param = new ROSLIB.Param({
            ros : this.ros,
            name : '/shoot_spot_node/DynamicShootParam' + ShootPoint + '/M4/' + Target + '/velocity'
        });
